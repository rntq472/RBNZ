...
seriesOptions <- function(series){
    ...
    allSeries <- list(
        ...
        B4 = list(NZD = 'hb4nzd', USD = 'hb4usd', EUR = 'hb4eur'),
        ...
        C5 = list(default = 'hc5'),
        C12 = list(monthend = 'hc12-month-end', dailyaverage = 'hc12-daily-average-balances'),
        C13 = list(issued = 'hc13-issued-in-nz', used = 'hc13-used-in-nz'),
        ##C30 = list(),##########
        ...
        C50 = list(default = 'hC50', longrun = 'hC50-long-run'),
        ...
        F3 = list(default = 'hf3'),
        F4 = list(default = 'hf4'),
        S10 = list(default = 'hS10', memo = 'hS10M'),
        S30 = list(default = 'hS30'),
        S31 = list(default = 'hS31'),
        S32 = list(default = 'hS32'),
        S33 = list(default = 'hS33', longrun = 'hS33-long-run'),
        S34 = list(default = 'hS34'),
        S40 = list(default = 'hS40', longrun = 'hS40-long-run'),
        ...
        D9 = list(default = 'hd9'),
        D30 = list(default = 'hD30'),#### Ignores concordance
        D31 = list(default = 'hD31'),#### Ignores concordance
        D35 = list(default = 'hD35'),#### Ignores concordance
        M1 = list(default = 'hm1', longrun = 'hm1-long'),
        M2 = list(default = 'hm2'),
        M3 = list(default = 'hm3'),
        M4 = list(default = 'hm4'),
        M5 = list(default = 'hm5'),
