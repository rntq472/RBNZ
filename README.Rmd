...
An overview of the package can be found on [CRAN](https://CRAN.R-project.org/package=RBNZ/vignettes/Overview.html) or in [vignettes/Overview.Rmd](https://github.com/rntq472/RBNZ/blob/master/vignettes/Overview.Rmd).
...
The main entry point is the `getSeries` function where users can choose a data series to retrieve:
...
One option is to email the RBNZ and request that your (static) public IP address be whitelisted. The email to contact is listed [here](https://www.rbnz.govt.nz/about-our-site/terms-of-use).
